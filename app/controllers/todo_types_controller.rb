class TodoTypesController < ApplicationController
  ...
  # GET /todo_types/1/edit
  def edit
  end

  # POST /todo_types
  # POST /todo_types.json
  def create
  ...
  # PATCH/PUT /todo_types/1
  # PATCH/PUT /todo_types/1.json
  def update
    respond_to do |format|
